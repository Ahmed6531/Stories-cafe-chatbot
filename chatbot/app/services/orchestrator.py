    ...
    try:
        ...
        if intent == "recommendation_query":
            ...
            if cart_items:
                ...
                complementary = suggest_complementary_items(menu_items, anchor_item)
        ...
        if intent == "update_quantity":
            ...
            if quantity is None and has_customization_hint and requested_item_has_customization(target_item):
                ...
                selected_options, instructions = map_requested_item_to_selected_options(target_item, menu_detail)
                    ...
                    if applied_labels:
                        if not multi_item_request:
                            ...
                            return ChatMessageResponse(
                                session_id=session_id,
                                status="ok",
                                reply=build_defaults_confirmation_prompt(item_display_name, applied_labels),
                                intent="add_items",
                                cart_updated=False,
                                cart_id=current_cart_id,
                                defaults_used=applied_labels,
